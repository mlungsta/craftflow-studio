...
CREATE INDEX idx_artifacts_project_created_at ON artifacts(project_id, created_at DESC);
...
CREATE INDEX idx_usage_logs_user_recorded_at ON usage_logs(user_id, recorded_at DESC);
CREATE INDEX idx_usage_logs_generation_id ON usage_logs(generation_id);
